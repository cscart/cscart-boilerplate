...
<div class="buy-together-notification product-notification--item">
{include file="common/image.tpl" image_width="50" image_height="50" images=$product.main_pair no_ids=true class="product-notification__image"}
    <div class="clearfix">
        ...
        <ul class="buy-together-notification-items">
            {if $product.product_option_data}
                <li class="buy-together-notification-item">{include file="common/options_info.tpl" product_options=$product.product_option_data}</li>
            {/if}
            <li class="buy-together-notification-item"><ul class="buy-together-notification_items">
            {foreach from=$added_products item="_product" key="_key"}
                {if $_product.extra.parent.buy_together == $key}
                    <li class="buy-together-notification-item">

...
{/if}
<a class="btn btn-default cm-modal-show cm-modal-update cm-modal-large" data-ca-view-id="{$product.product_id}" data-ca-target-id="product_quick_view" href="{$quick_view_url|fn_url}" data-ca-modal-title="{__("quick_product_viewer")}" rel="nofollow">{__("quick_view")}</a>
